...
class StoryToolkitEngine:
    ...
    def __init__(self, toolkit_ops_obj: Any) -> None:
        ...
        # search processors, worker threads, and mutable session state remain
        # private behind the engine's public search methods
        self._search_session_manager = SearchSessionManager(
            toolkit_ops_obj=self._toolkit_ops,
    ...
    def load_search_model(
        ...
        return self._search_session_manager.load_search_model(
            search_id=search_id,
            model_name=model_name,
        )
    ...
    def get_search_video_frame(
        ...
        return self._search_session_manager.get_search_video_frame(
            search_id=search_id,
            full_path=full_path,
            frame=frame,
        )
